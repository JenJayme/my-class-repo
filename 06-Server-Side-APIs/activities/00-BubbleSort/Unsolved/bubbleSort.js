...
//create a pointer to connect the starting unsorted array to the start div.
unsortedArr.getElementbyID("#start");
document.getElementbyID

//create a var to hold the new resulting array.
var newArray = [];

//Create a pointer to connect the new sorted array to the result div.
newArray.getElementbyID("#result");

//create vars to hold num1 and num2 for comparison. Might not need this actually...
var num1;
var num2;

//create a for-loop to compare adjacent numbers, if the first is less than the second, push the first into the new array.  Else push the second number into the array.
function bubbleSort() {
